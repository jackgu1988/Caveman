 ...
 * TextureLoader.java
 * 
 * This class creates rectangles loads textures for small icons (like the
 * enemies, the hero etc.)
 * 
...
public class TextureLoader {
	...
	/**
	 * Creates the object according to the screen height. Each image
	 * 
	 * @param img
	...
	public TextureLoader(int img, int height) {
		...
		// I split the display in 10 rows and each icon should have the size of
		// height/10
		float vert[] = { -height / 20, -height / 20, 0.0f, height / 20,
				-height / 20, 0.0f, -height / 20, height / 20, 0.0f,
				height / 20, height / 20, 0.0f };
	...
	/**
	 * Draw method, responsible for drawing the object and setting its
	 * properties.
	 * 
	 * @param gl
	 */
